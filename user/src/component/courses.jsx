...
import {Card , Typography ,  Button , CardMedia, CardContent , Grid} from '@mui/material';
   ...
   <Typography gutterBottom variant="h5" component="div">
     ...
     <div style={{ marginLeft:15 ,justifyContent:"space-between" , display:"flex"}}>
         <div>
          ...
          <div>
          <Button style={{marginRight: 20 , marginTop:10}}  variant="contained" onClick={()=>{
            fetch(`http://localhost:3000/courses/` + course._id , {method:"POST" , headers: {
                "authorization": "Bearer " + localStorage.getItem("token")
            }}).then((res) => {
                if(res.ok){
